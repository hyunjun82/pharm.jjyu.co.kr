...
export const products: Product[] = [
  ...
  // === 신규 추가 3개 (2026-03-02) ===
  {
    id: "imiru-contact-pure-12ml",
    name: "아이미루 콘택트 퓨어 12ml",
    image: "/images/barkiri-아이미루콘택트.webp",
    category: "일반의약품",
    categorySlug: "안약",
    description: "히알루론산 0.1% 콘택트렌즈 전용 인공눈물. 렌즈 착용 중 점안 가능한 무방부제 인공눈물이에요.",
    price: 4000,
    unit: "12ml",
  ...
  {
    id: "tearsil-ones-4-5g",
    name: "티어실 원스 4.5g",
    image: "/images/barkiri-티어실원스.webp",
    category: "일반의약품",
    categorySlug: "안약",
    description: "카르복시메틸셀룰로오스 0.5% 단회용 인공눈물. 무방부제 겔 타입으로 심한 건조증에 오래 지속돼요.",
    price: 9000,
    unit: "4.5g",
    barkiryProductId: "p612",
    ingredients: "카르복시메틸셀룰로오스나트륨",
    usage: "1회 1관, 필요 시 수시 점안",
    slug: "티어실원스",
  },
  {
    id: "tearstain-cleen-30pcs",
    name: "눈물자국 크린 두툼한 타입 30매",
    image: "/images/barkiri-눈물자국크린.webp",
    category: "일반의약품",
    categorySlug: "안약",
    description: "아이리드 클렌징 패드 30매. 눈꺼풀 가장자리와 속눈썹 주변 분비물·눈물 자국을 깨끗이 닦아줘요.",
    price: 2000,
    unit: "30매",
    barkiryProductId: "p1654",
    ingredients: "정제수,계면활성제",
    usage: "1일 1~2회, 패드로 눈꺼풀 가장자리를 가볍게 닦아냄",
    slug: "눈물자국크린",
  },
];