...
const EXTERNAL_BYEONBI = ["둘코락스좌약", "둘코락스좌약5개"];
const EXTERNAL_TALMO = ["미녹시딜", "판시딜", "두피나액", "판시딜액", "로게인", "카필러스폼", "미녹시폼", "판시딜액3", "동성미녹시딜3", "나녹시딜액", "나녹시딜액3", "마이딜액", "목시딜액", "백일후애액", "볼두민액", "마이녹실액", "메디녹실액", "복합마이녹실액", "미녹시딜바이그루트액3", "두피앤액"];
