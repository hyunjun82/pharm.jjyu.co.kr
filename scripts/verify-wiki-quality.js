...
const EXTERNAL_GUGANG = ["오라메디", "페리덱스", "알보칠", "헥사메딘", "탄툼액", "탄툼베르데네뷸라이저", "잇치페이스트", "잇치페이스트피톤치드향", "잇치페이스트프로폴리스", "가그린", "헥사메딘가글액", "구강청결겔", "아프타에이", "오라센스겔", "덴탈가드가글", "목앤스프레이", "아프타치정"];
const EXTERNAL_YEOSUNG = ["지노베타딘"];
const EXTERNAL_YONGYANGJE = ["블레파졸", "캐치티니핑썸머패치"];
// 외부카테고리에 있지만 실제 경구 복용하는 약 (복용법 사용)
const INTERNAL_ORAL_IN_EXTERNAL = ["아졸정", "제놀담푸러정", "스카풀라정10정"];
