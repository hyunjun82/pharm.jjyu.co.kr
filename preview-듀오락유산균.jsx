...
// ── 섹션 아이콘 매핑 (실제 Next.js SECTION_ICONS와 동일) ─────
...
// ── 데이터 (source-data/듀오락유산균.json 기반) ───────────────
const article = {
  ...
  faq: [
    {
      ...
      answer:
        "공식 섭취 방법은 식전·식후 구분 없이 1일 1회 1캡슐이에요. 중요한 건 매일 같은 시간에 빠뜨리지 않고 챙기는 거예요. 아침 식사 후, 잠들기 전 등 본인이 가장 잊지 않을 시간을 하나 정해두고 그 시간에 물 한 컵과 함께 드세요.",
    },
    {
      question: "듀오락 유산균은 언제부터 효과가 나타나나요?",
      answer:
        "배변 변화는 보통 2~4주 꾸준히 섭취하면서 체감하기 시작해요. 처음 1~2주는 가스가 늘거나 장이 더 예민해지는 느낌이 생길 수 있는데, 새로운 유산균이 장내에 자리잡는 적응 과정이에요. 이 시기에 중단하면 효과를 제대로 판단할 수 없어요.",
    },
    {
...
const relatedSpokes = [
  { slug: "종근당락토핏골드", desc: "40억 CFU + 아연 복합 분말형 유산균" },
  { slug: "뉴트리원프로바이오틱스", desc: "100억 CFU 캡슐형 뉴트리원 장 건강 유산균" },
  { slug: "비피도프로바이오틱스", desc: "100억 CFU 분말포 비피도 프로바이오틱스" },
];
...
function PriceCTA() {
  return (
    <a href={article.externalSearchUrl} target="_blank" rel="noopener noreferrer" style={{ display:"block", background:"#16a34a", color:"#fff", textAlign:"center", padding:"16px 24px", borderRadius:12, textDecoration:"none", boxShadow:"0 4px 14px rgba(22,163,74,0.25)", marginTop:4 }}>
  ...
  return (
    <div style={{ border:"1px solid #e5e7eb", borderRadius:12, background:"#fafafa", padding:18, marginTop:24, display:"flex", gap:14, alignItems:"flex-start" }}>
      ...
      <div>
        ...
        <div style={{ marginTop:8, display:"flex", gap:10, alignItems:"center", fontSize:11, color:"#9ca3af", flexWrap:"wrap" }}>
    ...
    <div style={{ fontFamily:"-apple-system,'Apple SD Gothic Neo','Noto Sans KR',sans-serif", background:"#f5f5f5", minHeight:"100vh", color:"#1a1a1a", fontSize:15, lineHeight:1.7 }}>
      ...
      <header style={{ background:"#fff", borderBottom:"1px solid #eee", padding:"12px 24px", display:"flex", alignItems:"center", position:"sticky", top:0, zIndex:100 }}>
        ...
        <nav style={{ marginLeft:"auto", fontSize:12, color:"#888", display:"flex", alignItems:"center", gap:4 }}>
          홈 <Icons.ChevronRight /> 유산균 <Icons.ChevronRight /> <span style={{ color:"#111", fontWeight:500 }}>듀오락유산균</span>
        </nav>
      </header>
      ...
      <section style={{ background:"linear-gradient(to bottom, #f0fdf4, #fff)", borderBottom:"1px solid #e5e7eb" }}>
        <div style={{ maxWidth:768, margin:"0 auto", padding:"40px 24px 28px" }}>
          ...
          <div style={{ marginTop:10, display:"flex", alignItems:"center", gap:10, fontSize:13, color:"#9ca3af", flexWrap:"wrap" }}>
            ...
            <span>|</span>
            <time>{article.datePublished} 작성</time>
          </div>
            ...
            <div style={{ border:"1px solid #e5e7eb", borderRadius:12, padding:"14px 16px", background:"#fff", display:"flex", justifyContent:"space-between", alignItems:"center", gap:12 }}>
              <div style={{ display:"flex", gap:14, alignItems:"center", minWidth:0 }}>
                ...
                <div style={{ minWidth:0 }}>
                  ...
                  <div style={{ fontSize:14, fontWeight:700, color:"#111", marginBottom:2 }}>듀오락 프로바이오틱스 60캡슐</div>
                  <div style={{ fontSize:12, color:"#6b7280" }}>프로바이오틱스 100억 CFU 캡슐형. 장 건강에 집중한 쎌바이오텍 대표 유산균.</div>
                </div>
              </div>
                    ...
                    <>
                      <section style={{ marginBottom:28 }}>
                        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                          ...
                          <h2 style={{ fontSize:16, fontWeight:700, color:"#111", margin:0 }}>듀오락 유산균 최저가 가격 비교</h2>
                        </div>
                        <div style={{ paddingLeft:42 }}>
                          <p style={{ fontSize:14, color:"#4b5563", lineHeight:1.85, marginBottom:16 }}>
                            듀오락 프로바이오틱스 60캡슐 기준 가격은 구매 채널마다 차이가 있어요. 네이버 쇼핑 실시간 최저가를 직접 비교해보세요.
                          </p>
                          <PriceCTA />
                        </div>
                        <hr style={{ marginTop:24, border:"none", borderTop:"1px solid #f3f4f6" }} />
